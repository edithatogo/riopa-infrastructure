...
- [~] **`governance_maori_data_sovereignty_20260718`** — Rights, privacy and scope-triggered data governance framework (target `0.3.0`, current `M2`, target `M6`, risk Critical; depends on: `foundation_architecture_20260718`)
- [~] **`security_supply_chain_20260719`** — Security, integrity and software supply-chain hardening (target `0.3.0`, current `M2`, target `M6`, risk Critical; depends on: `foundation_architecture_20260718`)
...
- [~] **`canonical_domain_schemas_ontology_20260719`** — Canonical domain schemas, identifiers and ontology (target `0.3.0`, current `M2`, target `M6`, risk High; depends on: `foundation_architecture_20260718`)
- [~] **`provenance_profile_v1_20260718`** — Shared provenance, transformation and quality profile v1 (target `0.3.0`, current `M2`, target `M6`, risk Critical; depends on: `foundation_architecture_20260718`, `security_supply_chain_20260719`)
...
- [~] **`nz_spatial_source_registry_20260718`** — New Zealand spatial source and authority registry (target `0.4.0`, current `M2`, target `M6`, risk High; depends on: `canonical_domain_schemas_ontology_20260719`, `provenance_profile_v1_20260718`)
