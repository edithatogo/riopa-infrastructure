...
| `FACILITY-HISTORY-EVENTS-20260822` | Append-only opening, closure, relocation, rebrand and source-disagreement history | `src/riopa_provenance/facility_registry.py`, `tests/test_facility_registry.py`, `docs/facility-history-contract.md` | Date/evidence validation and deterministic non-authoritative snapshot pass; source adjudication and public release filtering remain open |
