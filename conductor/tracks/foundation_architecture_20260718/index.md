...
| R03, R05 | Architecture review packet | `docs/architecture-review-template.md` | Pending two independent analyst records |
...
- `review-approval-required`: two independent analyst architecture reviews are required; analysts may be maintainers, external reviewers and/or agents, with distinct identities and scopes.
