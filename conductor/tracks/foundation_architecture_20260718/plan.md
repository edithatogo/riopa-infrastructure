...
- [x] R.7 Replace independent-analyst wording with distinct agent-panel lenses for the single-developer repository, while preserving factual hosted/provider, scope-triggered authority and release-authority gates. (`docs/foundation-agent-panel-wording-correction-20260825.json`)
