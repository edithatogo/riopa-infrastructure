...
- [x] 4.1c Refresh the non-authorizing snapshot from the exact clean merged reconciliation revision `e2a682b6`; `v0.4.0` preview preservation is reconciled while stable v1 remains blocked at 0/28 tracks and 0/14 gates (`docs/v1-stable-release-gate-snapshot-20260829-e2a682b6.json`, `tests/test_v1_release_gate_snapshot.py`).
