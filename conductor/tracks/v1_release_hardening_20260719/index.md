...
| V1-RC-PACKET-VALIDATION-20260829 | Machine-check the fail-closed candidate packet boundary and required unresolved gates | `scripts/validate_v1_release_candidate_packet.py`, `docs/v1-release-candidate-packet-validation-20260829.json`, `tests/test_v1_release_candidate_packet_validator.py` | Structure passes; signing, preservation, participant, soak and authority gates remain open |
| V1-RELEASE-DECISION-READINESS-VALIDATION-20260829 | Machine-check the non-authorising release-decision readiness projection | `scripts/validate_release_decision_readiness.py`, `docs/release-decision-readiness-validation-20260829.json`, `tests/test_release_decision_readiness_validator.py` | Projection remains promotion-disabled with pending authority and explicit blockers |
...
| V1-AGENT-OPERATED-JOURNEYS-20260825 | Two distinct owner-authorized agent-operated journey rehearsals with explicit non-substitution boundaries | `docs/v1-agent-operated-journeys-20260825.json`, `tests/test_v1_agent_operated_journeys.py`, `scripts/run_provenance_query_agent_workflow.py`, `scripts/run_template_journey.py` | Local journeys pass for bounded scope; exact stable-candidate role-separated journeys and clean-room reproduction, elapsed soak, preservation and authority remain open |
...
| V1-STABLE-GATE-SNAPSHOT-20260829 | Revision-bound successor reconciliation after current protected-main changes | `scripts/build_v1_release_gate_snapshot.py`, `docs/v1-stable-release-gate-snapshot-20260829.json`, `tests/test_v1_release_gate_snapshot.py` | Evaluates `898c5c2`; 0/28 tracks and 0/14 gates qualify; promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-40EF0515-20260829 | Exact-merged-revision successor after preservation, terminology and WP-006 reconciliation | `docs/v1-stable-release-gate-snapshot-20260829-40ef0515.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates clean merged revision `40ef0515`; `v0.4.0` preview preservation is complete, but 0/28 stable tracks and 0/14 stable gates qualify and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-F1DCDF9-20260829 | Exact-revision successor after planning-linkage and provenance-query contract hardening | `docs/v1-stable-release-gate-snapshot-20260829-f1dcdf9.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates revision `f1dcdf9`; 0/28 stable tracks and 0/14 stable gates qualify, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-4D598A91-20260829 | Exact-revision successor after track blocker metadata reconciliation | `docs/v1-stable-release-gate-snapshot-20260829-4d598a91.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates revision `4d598a91`; 0/28 stable tracks and 0/14 stable gates qualify, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-07686AC-20260829 | Exact-revision successor after remaining track blocker metadata reconciliation | `docs/v1-stable-release-gate-snapshot-20260829-07686ac.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates revision `07686ac`; 0/28 stable tracks and 0/14 stable gates qualify, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-9267C1C-20260829 | Exact-merged-revision successor after facility panel manifest hardening | `docs/v1-stable-release-gate-snapshot-20260829-9267c1c.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates clean merged revision `9267c1c`; 0/28 stable tracks and 0/14 stable gates qualify, RC exact-candidate continuity remains unmet, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-1FA16A6-20260829 | Exact-merged-revision successor after campaign revision-input hardening | `docs/v1-stable-release-gate-snapshot-20260829-1fa16a6.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates clean merged revision `1fa16a6`; 0/28 stable tracks and 0/14 stable gates qualify, beta/RC duration and exact-candidate continuity remain pending, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-012A0E7-20260829 | Exact-current-revision successor reconciliation; prior snapshots remain immutable | `docs/v1-stable-release-gate-snapshot-20260829-012a0e7.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates exact current revision `012a0e7`; 0/28 stable tracks and 0/14 stable gates qualify, and promotion remains forbidden |
| V1-STABLE-GATE-SNAPSHOT-B0F5D28-20260830 | Exact-current-revision successor reconciliation; prior snapshots remain immutable | `docs/v1-stable-release-gate-snapshot-20260830-b0f5d28.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates exact current revision `b0f5d28`; 0/28 stable tracks and 0/14 stable gates qualify, and promotion remains forbidden |
| OPS-HOSTED-BETA-RC-CAMPAIGN-OBSERVATION-20260829-CA3DF8DC | Fresh exact-revision beta and RC hosted observations on protected main | `docs/hosted-beta-rc-campaign-observation-20260829-ca3df8dc.json`, [beta run 33240248419](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33240248419), [RC run 33240257699](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33240257699) | Both passed on `ca3df8d`; observations start revision-specific segments but do not satisfy elapsed, stable-candidate preservation or authority gates |
| V1-CANDIDATE-HOSTED-VALIDATION-20260825 | Exact-candidate beta/RC reset, clean-room rehearsal, agent-user journey and pinned daily schedule | `docs/v1-candidate-hosted-validation-20260825.json`, `.github/workflows/evidence-campaign.yml`, [RC run 32856370956](https://github.com/edithatogo/riopa-infrastructure/actions/runs/32856370956), [beta runs 32857084789](https://github.com/edithatogo/riopa-infrastructure/actions/runs/32857084789) and [32857832666](https://github.com/edithatogo/riopa-infrastructure/actions/runs/32857832666), [clean-room run 32856533103](https://github.com/edithatogo/riopa-infrastructure/actions/runs/32856533103), [agent-user run 32856537212](https://github.com/edithatogo/riopa-infrastructure/actions/runs/32856537212) | Candidate `26bc0b4` passes all bounded lanes; beta has two observations over 428 seconds and RC has one 11-second observation; a future exact stable candidate requires new role-separated reproduction and user/operator journey evidence, and elapsed duration/cycles remain open |
| V1-STABLE-READINESS-PLAN-20260830 | Revision-bound stable-v1 campaign plan, gate-family matrix and contingencies | `docs/stable-v1-readiness-plan-20260830.json`, `tests/test_stable_v1_readiness_plan.py` | Preparation-only at candidate `26bc0b4`; all 14 stable gate families remain pending and promotion is disabled; clean beta/RC campaigns have one observation each |
| V1-CAMPAIGN-SCHEDULED-STATUS-CORRECTION-20260830 | Record the scheduled-qualification status correction separately from the immutable predecessor packet | `docs/campaign-scheduled-qualification-status-correction-20260830.json`, `docs/v1-candidate-hosted-validation-20260830.json`, `tests/test_v1_candidate_hosted_validation.py` | Successor correction records configured qualifying automation while the predecessor remains byte-stable; the next scheduled event remains pending and no elapsed or promotion claim |
| V1-HOSTED-BETA-RC-OBSERVATIONS-20260829 | Latest exact-candidate beta and RC hosted observations | `docs/hosted-beta-rc-observations-20260829.json`, `tests/test_hosted_beta_rc_observations.py`, [beta run 33232103718](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33232103718), [RC run 33232105006](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33232105006) | Both runs passed; elapsed, external, preservation, national-scale and owner-authority gates remain open |
| V1-HOSTED-BETA-RC-OBSERVATIONS-20260829-RERUN | Repeat exact-candidate beta and RC hosted observations | [beta run 33233333438](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33233333438), [RC run 33233334545](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33233334545) | Both runs passed on candidate `26bc0b49bcd84f409bf24b527e1049fd396c94a6`; elapsed, external, preservation, national-scale and owner-authority gates remain open |
| V030-EXPERIMENTAL-M2-RELEASE-EVIDENCE-20260827 | Exact-revision evidence for all five required M2 tracks and four repository-owned `0.3.0` core gates | `conductor/release-evidence/0.3.0.json`, `tests/test_v030_release_evidence.py` | `0.3.0` readiness passes at 5/5 tracks and 4/4 gates without waivers; the five tracks remain validating toward M6 and every later release remains blocked |
| V030-RELEASE-PREPARATION-20260827 | Coordinated software, citation, CodeMeta, programme and release-note version surfaces | `pyproject.toml`, `uv.lock`, `src/riopa_provenance/__init__.py`, `CITATION.cff`, `codemeta.json`, `CHANGELOG.md`, `tests/test_v030_release_preparation.py` | Protected `v0.3.0` tag preparation passes; no tag, hosted release run or published asset is claimed by preparation alone |
| V030-RELEASE-PUBLICATION-20260827 | Exact annotated tag, hosted build/checksum/attestation results, bounded publication recovery and downloaded-asset verification | `docs/v0.3.0-release-publication-20260827.json`, `tests/test_v030_release_publication.py`, [release](https://github.com/edithatogo/riopa-infrastructure/releases/tag/v0.3.0), [run 33016204338](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33016204338) | Experimental prerelease is published and assets verify; the workflow is truthfully recorded as failed overall because automated publication lacked a checkout, and the exact-artifact manual recovery plus future-workflow fix are explicit |
