...
| Quality frontier qualification | Python 3.14 suite, branch-aware coverage, applicability and explicit exclusions recorded | `docs/quality-frontier-qualification-20260803.json`, `.github/workflows/mutation.yml`, `scripts/check_mutation_score.py`, `scripts/check_workflow_lint.py`, `scripts/check_tracked_secrets.py` | Bounded validation/publication mutation lane measured 68.78% against a 65% floor; surviving mutants, cross-language parity and provider-side secret-scanning evidence remain open |
