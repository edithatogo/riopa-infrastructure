...
| V1-STABLE-GATE-SNAPSHOT-E2A682B6-20260829 | Exact-merged-revision successor after preservation, terminology and WP-006 reconciliation | `docs/v1-stable-release-gate-snapshot-20260829-e2a682b6.json`, `scripts/build_v1_release_gate_snapshot.py`, `tests/test_v1_release_gate_snapshot.py` | Evaluates clean merged revision `e2a682b6`; `v0.4.0` preview preservation is complete, but 0/28 stable tracks and 0/14 stable gates qualify and promotion remains forbidden |
