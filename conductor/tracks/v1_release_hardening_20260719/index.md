...
| V1-STABLE-READINESS-PLAN-20260829 | Revision-bound stable-v1 campaign plan, gate-family matrix and contingencies | `docs/stable-v1-readiness-plan-20260829.json`, `docs/stable-v1-readiness-plan-20260829.md`, `tests/test_stable_v1_readiness_plan.py` | Preparation-only at protected head `b8cf970`; all 14 stable gate families remain pending and promotion is disabled |
