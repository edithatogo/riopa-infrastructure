...
| `PLANNING-LINK-SAMPLE-PANEL-20260825` | Four-lens agent-panel review and bounded error accounting over two structurally different synthetic fixtures | `docs/planning-link-sample-panel-review-20260825.json`, `tests/test_planning_link_sample_panel_review.py` | Synthetic contracts are qualified with unresolved feasibility retained; real council evidence, role-separated agent-panel evidence, legal interpretation and authority remain open |
...
| `PLANNING-LINKAGE-ERROR-INTEGRITY-20260829` | Content-digest, category-count and non-promotion validation for bounded linkage-error reports | `src/riopa_provenance/planning.py::validate_planning_linkage_error_report`, `docs/planning-linkage-error-integrity-20260829.json`, `tests/test_planning_linkage_error_report.py` | Validator and negative tests pass; real council, legal interpretation, external participation, preservation and authority gates remain open |
