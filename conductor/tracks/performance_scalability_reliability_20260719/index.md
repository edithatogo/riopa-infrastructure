...
| `PERFORMANCE-HOSTED-OBSERVED-20260829` | Re-run the bounded scale-smoke and performance-rehearsal lanes on the pinned candidate | [Scale-smoke run 33233407509](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33233407509), [performance-rehearsal run 33233408928](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33233408928) | Both hosted lanes passed on candidate `26bc0b49bcd84f409bf24b527e1049fd396c94a6`; this is current bounded/reference evidence, not national-scale, production SLO, elapsed-soak, failure-injection or release-authority qualification |
