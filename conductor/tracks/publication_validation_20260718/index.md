...
| `WP-010-reviewer-ready-synthetic-benchmark-20260801` | A fixed benchmark and independent standard-library verifier provide a bounded clean-room exercise | `examples/wp010-synthetic-benchmark/`, `scripts/build_wp010_reviewer_bundle.py`, `tests/test_wp010_benchmark.py` | Repository-owned reproduction and the content-bound all-track agent panel pass as bounded evidence; external participant reproduction remains pending |
