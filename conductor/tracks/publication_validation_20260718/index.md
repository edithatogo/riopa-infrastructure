...
| `PUB-AGENT-USER-WORKFLOWS-20260821` | Two distinct owner-authorized agent user journeys are scripted with content-bound logs | `scripts/run_agent_user_workflows.py`, `tests/test_hosted_evidence.py`, `.github/workflows/evidence-campaign.yml` | Locally validated; hosted execution is the next campaign action and remains non-operational |
