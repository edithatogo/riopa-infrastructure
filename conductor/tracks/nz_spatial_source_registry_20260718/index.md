...
| `SOURCE-REGISTRY-ENDPOINT-INTEGRITY-20260829` | Reject empty and duplicate endpoint identifiers in release candidates | `src/riopa_provenance/registry.py`, `tests/test_registry.py`, `docs/source-registry-endpoint-integrity-20260829.json` | Negative integrity tests pass; live health, authority and release gates remain open |
