...
| `HEALTH-METHODS-REPORTING-20260825` | Versioned bounded methods, reporting and limitations template | `docs/health-methods-reporting-template-20260825.json`, `tests/test_health_methods_reporting_template.py` | Candidate template is validated; isolated role-separated clean-room agent reproduction, elapsed, clinical and authority gates remain open |
