...
| `WP-002-source-health-20260730` | Deterministic freshness, change, degradation and disappearance classification | `src/riopa_provenance/health.py`, `tests/test_health.py` | Implemented as pure classifier; adapter persistence and full runtime suite pending |
