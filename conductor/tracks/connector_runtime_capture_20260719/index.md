...
| `CONNECTOR-AUTHORING-CONTRACT-CLOSEOUT-20260825` | Repository-owned adapter authoring contract, required controls and non-authorizing boundaries | `docs/connector-adapter-authoring-guide-20260824.md`, `docs/connector-adapter-contract-20260824.json`, `tests/test_connector_authoring_contract.py` | Contract completeness is validated; live-source, rights/publication, preservation and external qualification remain open |
