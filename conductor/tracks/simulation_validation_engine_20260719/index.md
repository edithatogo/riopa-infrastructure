...
| `SIMULATION-REFERENCE-CROSSCHECK-20260825` | Separate availability-list reference path cross-checks the deterministic FCFS engine | `src/riopa_provenance/analysis.py::compare_fcfs_reference_implementations`, `docs/simulation-reference-crosscheck-20260825.json`, `tests/test_analysis.py` | Synthetic parity is exact and promotion-disabled; external implementation, published benchmark, real-data and operational validation remain open |
| `WP-010-SINGLE-DEVELOPER-CLOSEOUT-20260829` | Bounded work-package reproduction and operator/user journeys use the prospective sole-developer agent-panel policy | `docs/wp010-single-developer-closeout-20260829.json`, `docs/hosted-evidence-batch-20260802.json`, `docs/v1-agent-operated-journeys-20260825.json` | WP-010 repository scope is complete; empirical calibration, elapsed operation and promotion authority remain separate track gates |
