...
| `V040-GITHUB-PRERELEASE-RECEIPT-20260829` | Observe the protected v0.4.0 GitHub prerelease and bind its published assets to their SHA-256 digests | `docs/v0.4.0-github-prerelease-receipt-20260829.json`, [GitHub prerelease](https://github.com/edithatogo/riopa-infrastructure/releases/tag/v0.4.0) | Published prerelease observed with six digest-bearing assets; this is not stable-v1, preservation acceptance, external reproduction, elapsed soak or release-authority evidence |
| `V040-PUBLICATION-20260829` | Exact merged technical preview is built, checksummed, OIDC-attested, published, downloaded and independently reverified | `docs/v0.4.0-release-publication-20260829.json`, [release](https://github.com/edithatogo/riopa-infrastructure/releases/tag/v0.4.0), [run 33236124879](https://github.com/edithatogo/riopa-infrastructure/actions/runs/33236124879) | Public prerelease passes GitHub publication and 65/65 RO-Crate checks; Zenodo/Hugging Face were not attempted because no credential was configured; stable-v1 gates remain open |
