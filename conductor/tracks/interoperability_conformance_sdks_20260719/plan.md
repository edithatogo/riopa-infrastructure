...
- [x] R6 Mirror the six exact release assets and bounded metadata to the public `edithatogo/riopa-evidence-campaign` dataset, bind commit `ebecf6d38084aa459b27ef2bf753505003b08a16`, and anonymously re-download all seven files with byte equality and checksum verification (`docs/v0.4.0-release-publication-20260829.json`).
