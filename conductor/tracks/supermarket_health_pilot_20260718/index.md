...
| `SUPERMARKET-FOOD-SERVICE-SUPPLEMENT-20260829` | Assess the archived OSM food-service packet as a possible supplementary source without inferring supermarket status | `docs/supermarket-supplementary-food-service-disposition-20260829.json`, `tests/test_supermarket_supplementary_food_service_disposition.py`, [Hugging Face archive revision](https://huggingface.co/datasets/edithatogo/riopa-public-data-archive/tree/001137c0df64e9f8a7b0539fd0286a7cd5819ce7) | 13,650 records are archived, but none has exact type `supermarket`; context-only sensitivity input, not a registry or availability evidence |
| `SUPERMARKET-ARCHIVED-SNAPSHOT-BUILDER-20260829` | Materialize a versioned assertion snapshot from a local archived GeoJSON payload | `src/riopa_provenance/supermarket_pilot.py:build_archived_supermarket_snapshot`, `scripts/build_archived_supermarket_snapshot.py`, `tests/test_supermarket_pilot.py` | No-network converter and malformed-input tests pass; output is public-only, non-authoritative and promotion-disabled |
