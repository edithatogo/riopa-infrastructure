...
- [x] R7 Require non-empty report identity and generation fields in the
  candidate bundle validator, with negative coverage
  (`scripts/build_operations_report_bundle.py`, `tests/test_operations_report_bundle.py`,
  `docs/operations-report-bundle-identity-validation-20260829.json`).
