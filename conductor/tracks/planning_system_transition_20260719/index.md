...
| `PLANNING-TRANSITION-RELEASE-PACKET-20260825` | Digest-bound unpublished transition-record candidate packet | `src/riopa_provenance/transitions.py:build_transition_release_packet`, `docs/planning-transition-release-packet-contract-20260825.json`, `tests/test_transitions.py` | Packet construction is bounded and promotion-disabled; legal authority, real historical-source, preservation and release gates remain open |
