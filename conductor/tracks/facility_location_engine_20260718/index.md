...
| `FACILITY-STOCHASTIC-STRESS-20260825` | Seeded stress rehearsal is available through the bounded facility-location reference surface | `src/riopa_provenance/facility_location.py:stochastic_stress_test`, `tests/test_facility_location.py`, `tests/test_simulation_stochastic_stress.py` | Deterministic fixture rehearsal passes with promotion disabled; national-scale, calibrated, external and operational evidence remains open |
