...
- [~] 3.11 Integrate receipt-bound cycle ledger persistence into the Tasman Actions workflow with verified immutable Hugging Face checkpoints, concurrent-writer reconciliation and failure receipts; keep scheduled/change/recovery qualification separate.
