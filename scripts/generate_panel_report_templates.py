...
def generate(tracks_root: Path, output: Path) -> None:
    ...
    for metadata_path in sorted(tracks_root.glob("*/metadata.json")):
        ...
        entries.append({
            ...
            "notes": "Template only. Populate from content-bound panel execution; do not infer a result from missing evidence.",
        })
    payload = {
...
if __name__ == "__main__":
    ...
    generate(root / "conductor" / "tracks", root / "docs" / "panel-qualification-report-templates-20260801.json")
