...
| 0006 | Standards profile | accepted in principle; conformance inventory remains open | Interoperability maintainer | Track in conformance work package |
...
| 0009 | Security/trust model | accepted as baseline; qualification pending | Security reviewer | Complete threat and supply-chain qualification |
...
| 0011 | v1 release authority | proposed for ratification | Release authority | Requires named signatories and reproduction evidence |
