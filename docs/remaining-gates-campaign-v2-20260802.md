...
| External workflows | Use agents for review; retain operators/users only as factual participant evidence | One external operator and two external-user workflow records if beta/RC/stable criteria remain unchanged | Remain technical preview or formally change the release scope |
