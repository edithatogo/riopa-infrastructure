...
|---|---|---|---|---|
| Independent WP-010 reproduction | External gate open; internal subagent review is recorded in `reports/wp010-subagent-review-20260801.md`; issue [#149](https://github.com/edithatogo/riopa-infrastructure/issues/149) remains open | Stable external reviewer identity or pseudonym, environment, exact revision/bundle digest, commands, findings and signed/content-bound report | Independent external person/operator | Internal subagent review is useful supporting evidence only; no independent-reproduction or stable-release claim |
