...
| ID | Severity | Requirement / artifact | Finding | Disposition | Remediation issue |
|---|---|---|---|---|---|
|  |  |  |  | open / resolved / accepted exception |  |

## Confirmation

- [ ] Responsibility boundaries are understandable and non-overlapping.
- [ ] Version axes and compatibility rules are actionable.
- [ ] Non-claims and governance prohibitions are visible.
